...
class wc4bp_bookings_required {
    ...
    public function remove_woo_footer() {
        ...
        if ( isset( $current_screen->id ) && $current_screen->id == 'admin_page_wc4bp-booking-install-plugins' && class_exists( 'WC_Admin' ) ) {
    ...
    public static function is_current_active() {
        ...
        return is_plugin_active( 'wc4bp-booking/wc4bp-booking.php' );
    }
    ...
    public function setup_and_check() {
        ...
        $config = array(
            'id'           => 'wc4bp-bookings',                 // Unique ID for hashing notices for multiple instances of TGMPA.
            'menu'         => 'wc4bp-bookings-install-plugins', // Menu slug.
